...
_TOKENS: Dict[str, AppColorTokens] = {
    ...
    "red_white": AppColorTokens(
        # Blanco y rojo (inverso del antiguo “rojo y blanco”): superficies claras, texto oscuro, acentos rojos.
        win_bg="#faf6f6",
        win_fg="#1f1214",
        surface="#ffffff",
        surface_alt="#fff5f5",
        ...
        tooltip_bg="#fffafa",
        tooltip_fg="#1a0a0c",
        tooltip_border="#d4a8a8",
        toolbar_bg="#f4eaea",
        toolbar_border_bottom="#d8b8b8",
        toolbar_sep="#c9a0a0",
        left_panel_bg="#f0e6e6",
        left_panel_border="#d4b0b0",
        dock_border="#d4b0b0",
        dock_title_bg="#fde8e8",
        dock_title_fg="#3d1010",
        dock_title_border_bottom="#d4a0a0",
        dock_bar_bg="#fde8e8",
        dock_bar_border_bottom="#d4a0a0",
        dock_lbl="#3d1010",
        tab_pane_border="#d4b8b8",
        tab_pane_bg="#faf6f6",
        tab_inactive_bg="#f5e4e4",
        tab_inactive_fg="#4a2020",
        tab_inactive_border="#d4b0b0",
        tab_hover_bg="#edd4d4",
        menubar_bg="#faf6f6",
        menubar_fg="#1f1214",
        menubar_border_bottom="#e0c8c8",
        menubar_item_selected="#fde8e8",
        menu_border="#d4a8a8",
        menu_separator="#e8c8c8",
        groove="#e8d8d8",
        model_footer_bg="#fff5f5",
        model_footer_border="#d4b0b0",
        mini_del_bg="#fce8e8",
        mini_del_fg="#5a2020",
        mini_del_border="#c89898",
        mini_del_hover_bg="#f5d8d8",
        mini_del_hover_border="#b07070",
        mini_del_pressed="#edd0d0",
        accent="#b91c1c",
        accent_hover="#c62828",
        accent_pressed="#9a1818",
        accent_border="#7a1414",
        accent_soft="#f5d4d4",
        accent_soft_border="#d08080",
        selection_bg="#f0c4c4",
        selection_fg="#1a0808",
        slider_handle="#b91c1c",
        slider_subpage="#e0b8b8",
        tab_selected_bg="#ffffff",
        tab_selected_fg="#8b1515",
        tab_selected_border="#d4b8b8",
        tab_selected_bottom="#b91c1c",
        mini_add_bg="#fde8e8",
        mini_add_fg="#7a1414",
        mini_add_border="#d08080",
        mini_add_hover_bg="#f5d4d4",
        mini_add_hover_border="#c04040",
        mini_add_pressed="#edd0d0",
        analyze_bg="#b91c1c",
        analyze_fg="#ffffff",
        analyze_border="#7a1414",
        analyze_hover="#c62828",
        analyze_pressed="#9a1818",
        analyze_hover_border="#a01818",
        text_muted="#7a5a5a",
        combo_bg="#ffffff",
        combo_fg="#1f1214",
        combo_border="#d0b0b0",
        combo_hover_border="#b91c1c",
        combo_popup_bg="#ffffff",
        combo_popup_fg="#1f1214",
        combo_popup_border="#d4a8a8",
        combo_item_hover_bg="#fde8e8",
        table_bg="#ffffff",
        table_fg="#1f1214",
        grid="#edd8d8",
        table_border="#d4c0c0",
        ...
        push_fg="#1f1214",
        push_border="#d0b8b8",
        push_hover_bg="#fde8e8",
        push_hover_border="#b91c1c",
        push_pressed="#f5d4d4",
        status_bg="#8b1515",
        status_fg="#fff8f8",
        status_border_top="#6a1010",
        status_legend="rgba(255,248,248,0.82)",
        status_summary="#ffffff",
        danger_hover_bg="#fce8e8",
        danger_hover_border="#c04040",
        tool_hover_bg="#fde8e8",
        tool_hover_border="#d08080",
        tool_pressed="#f0d8d8",
        ws_checked_bg="#f0c4c4",
        ws_checked_border="#b91c1c",
    ),
